  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          var userExist = await widget.dataBaseService.userExist(
            widget.usernameController.text,
          );
          print("dsfsd");
          print(userExist);
          if (userExist != 1) {
            CustomPopUp.show(context, "User Not Found.", "Try again");
          }
          ...
          if (loggedInUser != null) {
            print(loggedInUser.balance); // Assign the loggedInUser to userModel
