...
class _MyProductsViewState extends State<MyProductsView> {
  ...
  void fetchData() async {
    ...
    numPurchased = (await widget.dataBaseService
            .getNumPurchBSI(widget.userModel.userName)) ??
        "No Sales";
        ...
        child: Column(
          children: [
            Column(
              children: [
                CustomTextWidget(
                    textString: "Name of the best-selling product:",
                    fontSize: 15),
                CustomTextWidget(textString: numPurchased, fontSize: 15),
              ],
            ),
            Padding(
